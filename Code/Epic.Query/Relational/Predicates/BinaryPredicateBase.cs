...
namespace Epic.Query.Relational.Predicates
{
    ...
    public abstract class BinaryPredicateBase : Predicate, IEquatable<BinaryPredicateBase>
    {
        ...
        /// <see cref="Epic.Query.Relational.Predicates.BinaryPredicateBase`2"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="BinaryPredicateBase<TPredicate1,TPredicate2>"/> is equal to the current <see cref="Epic.Query.Relational.Predicates.BinaryPredicateBase`2"/>.
        /// </summary>
        /// <param name='other'>
        /// The <see cref="BinaryPredicateBase<TPredicate1,TPredicate2>"/> to compare with the current <see cref="Epic.Query.Relational.Predicates.BinaryPredicateBase`2"/>.
        /// </param>
        /// <returns>
        /// <c>true</c> if the specified <see cref="BinaryPredicateBase<TPredicate1,TPredicate2>"/> is equal to the
        /// current <see cref="Epic.Query.Relational.Predicates.BinaryPredicateBase`2"/>; otherwise, <c>false</c>.
        /// </returns>
        public abstract bool Equals(BinaryPredicateBase other);

        /// <summary>
        /// Determines whether the specified <see cref="Predicate"/> is equal to the current <see cref="Epic.Query.Relational.Predicates.BinaryPredicateBase`2"/>.
        /// </summary>
        /// <param name='other'>
        /// The <see cref="Predicate"/> to compare with the current <see cref="Epic.Query.Relational.Predicates.BinaryPredicateBase`2"/>.
        /// </param>
        /// <returns>
        /// <c>true</c> if the specified <see cref="Predicate"/> is equal to the current
        /// <see cref="Epic.Query.Relational.Predicates.BinaryPredicateBase`2"/>; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <see cref="Epic.Query.Relational.Predicates.BinaryPredicateBase`2"/> object.
        /// </summary>
        /// <returns>
