...
namespace Epic.Query.Relational.Predicates
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Epic.Query.Relational.Predicates.Xor`2"/> class.
        /// </summary>
        ...
        /// </summary>
        /// <param name='other'>
        /// The <see cref="BinaryPredicateBase"/> to compare with the current <see cref="Epic.Query.Relational.Predicates.Xor`2"/>.
        /// </param>
        /// <returns>
        /// <c>true</c> if the specified <see cref="BinaryPredicateBase"/> is equal to the
        /// current <see cref="Epic.Query.Relational.Predicates.Xor`2"/>; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="Xor<Predicate,Predicate>"/> is equal to the current <see cref="Epic.Query.Relational.Predicates.Xor`2"/>.
        /// </summary>
        /// <param name='other'>
        /// The <see cref="Xor<Predicate,Predicate>"/> to compare with the current <see cref="Epic.Query.Relational.Predicates.Xor`2"/>.
        /// </param>
        /// <returns>
        /// <c>true</c> if the specified <see cref="Xor<Predicate,Predicate>"/> is equal to the current
        /// <see cref="Epic.Query.Relational.Predicates.Xor`2"/>; otherwise, <c>false</c>.
        /// </returns>
