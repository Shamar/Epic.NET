...
{
    [TestFixture()]
    public class OfTypeQA : RhinoMocksFixtureBase
    {
        [Test]
        public void Initialize_withASpecification_works ()
        {
            ...
            // act:
            var toTest1 = new OfType<Fakes.FakeCandidate1Abstraction, Fakes.FakeCandidate1>(inner1);
            var toTest2 = new OfType<Fakes.FakeCandidate1, Fakes.FakeCandidate1Abstraction>(inner2);
        ...
        public void Initialize_withoutASpecification_throwsArgumentNullException ()
        {
            ...
            Assert.Throws<ArgumentNullException>(delegate() {
                new OfType<Fakes.FakeCandidate1Abstraction, Fakes.FakeCandidate1>(null);
            });
        }
        ...
        public void Initialize_withUnrelatedCandidateTypes_throwTypeInitializationException ()
        {
            ...
            Assert.Throws<TypeInitializationException>(delegate() {
                new OfType<Fakes.FakeCandidate2, Fakes.FakeCandidate1>(inner);
            });
        }
        ...
        public void Initialize_withTwoEqualsCandidateTypes_throwTypeInitializationException ()
        {
            ...
            // act:
            Assert.Throws<TypeInitializationException>(delegate() {
                new OfType<Fakes.FakeCandidate1, Fakes.FakeCandidate1>(inner);
            });
        }
        ...
        public void Equals_withAnotherWithEqualsInner_isTrue ()
        {
            ...
            var toTest1 = new OfType<Fakes.FakeCandidate1Abstraction, Fakes.FakeCandidate1>(inner);
            var other = new OfType<Fakes.FakeCandidate1Abstraction, Fakes.FakeCandidate1>(inner);
        ...
        public void IsSatisfiedBy_Candidates_thatSatisfyTheInnerSpecification ()
        {
            ...
            ISpecification<Fakes.FakeCandidate1Abstraction> toTest = new OfType<Fakes.FakeCandidate1Abstraction, Fakes.FakeCandidate1>(inner);
