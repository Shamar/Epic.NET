...
{
    [TestFixture]
    public class UnionQA : RhinoMocksFixtureBase
    {
        ...
        {
            // assert:
            Assert.Throws<ArgumentNullException>(() => new Union(null, fakeRelation2));
            Assert.Throws<ArgumentNullException>(() => new Union(fakeRelation1, null));
        }
        ...
        {
            // act:
            Union toTest = new Union(fakeRelation1, fakeRelation2);
        ...
        {
           // act:
            Union firstJoin = new Union(fakeRelation1, fakeRelation2);
            Union secondJoin = firstJoin;
        ...
        public void Equals_AgainstEquivalentObject_works()
        {
            // act:
            Union firstJoin = new Union(fakeRelation1, fakeRelation2);
            Union secondJoin = new Union(fakeRelation1, fakeRelation2);
        ...
        public void Test_Serialization_Works()
        {
            ...
            // act:
            Stream stream = SerializationUtilities.Serialize<Union>(toTest);
        ...
        public void Test_deserialization_Works()
        {
            ...
            // act:
            Stream stream = SerializationUtilities.Serialize<Union>(toTest);
            Union deserialized = SerializationUtilities.Deserialize<Union>(stream);
        ...
        public void Accept_withValidArguments_delegateVisitToTheRightVisitor()
        {
            ...
            IVisitor<object, Union> selectionVisitor = GenerateStrictMock<IVisitor<object, Union>>();
