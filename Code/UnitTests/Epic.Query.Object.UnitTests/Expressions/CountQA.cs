...
namespace Epic.Query.Object.UnitTests.Expressions
{
    ...
    public class CountQA : RhinoMocksFixtureBase
    {
        ...
        public void Initialize_withASource_works()
        {
            ...
            // act:
            Count<ICargo> count = new Count<ICargo>(source);

            // assert:
            Assert.AreSame(source, count.Source);
        }
        ...
        public void Serialization_works()
        {
            ...
            // act:
            Stream stream = SerializationUtilities.Serialize(count);
        ...
        public void Accept_withValidArguments_delegateVisitToTheRightVisitor()
        {
            ...
            expressionVisitor.Expect(v => v.Visit(count, context)).Return(expectedResult).Repeat.Once();
            IVisitor<object> visitor = GenerateStrictMock<IVisitor<object>>();
            visitor.Expect(v => v.GetVisitor(count)).Return(expressionVisitor).Repeat.Once ();

            // act:
            object result = count.Accept(visitor, context);
